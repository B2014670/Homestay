...
//                   }
//                   className="input-class-name w-[60px] rounded-md mr-1 pl-1"
//                 />{" "}
//               </div>
//               <div className="justify-center items-center flex">
//                 <input
...
import { Form, Input, Select, Slider, DatePicker, Button, Space } from 'antd';
  ...
  return (
    <div className="container mx-auto lg:px-20 md:px-2 px-1 sm:px-6 py-8">
      ...
      {/* <div className="h-[70px] w-full rounded-md bg-slate-500 searchRooms flex justify-center items-center">
        ...
        <button className="searchRoomsButton flex items-center justify-center" onClick={handleReset}>
